...
<!-- div class="jumbotron">
  <div class="container">
    <h1>Hello, world!</h1>
    <p>Ahora no es necesario que vengas a nuestras oficinas para entregar tus archivos. Regístrate y súbelos aquí</p>
    <p><a class="btn btn-primary btn-lg" href="#" role="button">Comienza Ahora</a></p>
  </div>
</div -->
  ...
  <div class="container">
    <div class="row">
      <div class="col-sm-12 col-md-12 col-lg-12">
          ...
          <h4>Ahora no es necesario que vengas a nuestras oficinas para entregar tus archivos. Regístrate y súbelos aquí</h4>
    ...
    <div class="row">
      ...
      <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
        <div class="box-servicio">
          ...
          <h4>Pendones</h4>
          <p>Para la publicidad exterior de tu empresa, para las exposiciones y ponencias de las diferentes actividades que se realizan, eventos de promoción, conferencias, bazares.</p>
        </div>
      </div>
    </div>
